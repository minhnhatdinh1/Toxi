  ...
  fetch("http://localhost:8080/api/quizzes", {
    ...
    .then(res => {
      const mapped = res.data.map(q => ({
        id: q.quizId,
        title: q.title,
        level: `HSK ${q.hsklevel}`,
        description: q.description,
        image: q.thumbnail || "https://via.placeholder.com/300x200",
        duration: `${q.timeLimit} phút`,
        questions: `${q.totalQuestions} câu`,
        attempts: q.playCount + " lượt",
        badge: "primary",
        rating: 4.8
      }));
