  ...
  if (!product) {
    return (
      <div className="flex justify-center items-center h-screen">
        <div className="animate-pulse text-gray-400">Ðang t?i s?n ph?m...</div>
      </div>
    );
  }
  ...
  <div className="max-w-[1920px] mx-auto px-4 md:px-8 py-4 flex items-center justify-between gap-8 relative z-10">
    ...
    <div className="flex-1 max-w-2xl hidden md:block">
      <div className="relative group">
        <input
          type="text"
          placeholder="Tìm ki?m s?n ph?m, giáo trình, d?ng c?..."
    ...
    <div className="flex items-center gap-4 shrink-0">
      ...
      {localStorage.getItem("token") ? (
            ...
            <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-2xl shadow-xl border border-slate-100"
              ...
              <div className="px-4 py-4 border-b border-slate-100">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-slate-400 truncate">{localStorage.getItem("email") || "H?c viên TOXI"}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="py-2">
                {[
                  ...
                  { icon: "school", label: "Khóa h?c c?a tôi", to: "/MyCourse" },
                  { icon: "shopping_bag", label: "Ðon hàng", to: "/MyProduct" },
        ...
        <div className="flex items-center gap-2">
          <Link to="/login">
            <button className="text-white/80 font-bold text-sm hover:text-white transition-colors">Ðang nh?p</button>
          </Link>
          <Link to="/register">
            <button className="bg-secondary text-primary px-4 py-2 rounded-full font-bold text-sm shadow-lg hover:brightness-110 transition-all">Ðang ký</button>
          </Link>
        </div>
      )}
    </div>
            ...
            <div className="lg:col-span-7 flex flex-col">
              ...
              <div className="flex items-center gap-6 mb-6">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-sm font-bold text-slate-700">
                    {averageRating} ({reviewCount} dánh giá)
                  </span>
                </div>
                <div className="h-4 w-px bg-slate-300"></div>
                <p className="text-sm text-slate-500 font-medium">
                  Ðã bán 1.250 s?n ph?m
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl mb-8 border border-slate-100 shadow-sm relative overflow-hidden">
                ...
                <p className="text-accent-red text-sm font-bold flex items-center gap-2">
                  ...
                  Ti?t ki?m {formatCurrency(saved)} VND khi mua hôm nay
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                <button   onClick={handleAddToCart} className="flex-[1.5] px-8 py-5 bg-primary text-secondary font-bold rounded-2xl shadow-xl shadow-primary/20 hover:bg-primary-dark transition-all flex items-center justify-center gap-3 group">
                  ...
                  <span className="text-lg">Thêm vào gi? hàng</span>
                </button>
                <button  onClick={() => {
    handleAddToCart();
    navigate("/checkout");
