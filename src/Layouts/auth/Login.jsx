    ...
    return (
      ...
      <div className="relative w-full max-w-[900px] bg-[#fcfbf8] dark:bg-[#1a1a1a] rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden z-10">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            <img
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuBriWEOO-1WKi8fFJbC7P2VyBaxPjdSPBJHKIeizLnKTv6zTWKVmXz8ZjHBrtHL4HzvBTJSMlHlF6OPF5lbbAh4KZ5ViMbw8O6ZN9btXk5hS8ruJBUxNtBf7NzyfWPK0kv0KFgJnVKX432YLAWTePZr9Vo4BODSp6fDj5v9sdjk3hBGRNLUKSjahqnMps1RDHf8yEi1dlHQGeS2s-Mst6oPZt2v2oLFBUCWCDhzJcAcn_NC2W0Ddj1ANwpf-dRIV8oSgEbpY8h6sOU"
              alt="Google"
          ...
          >
            <img
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuDc4JXfeUY_AWR25h041gxP0zo7p0H5XPwRTiUG0mCeD37yswH6WkSk9tUTWuJ0IsRfAc9a3WvbciXqx1vj_LryMIFSqnAgLTnvDTQ6ywEXJjHiiW5nRLcnqpclKD0sE3Cppxn8_qHjnNo7TznT_mmxKkCrO1ZFgI7dyRhLRhhF3B2FYtOj8q-Pc_NRIsxcItQ5LbT6wXoSkjrXkwj1F7MrtfcbjDzwIcDhs5Wv6hpfcviUCAVsb0AWI1L6dsdw5xma0jvqEkF7COo"
              alt="Facebook"
              className="w-5 h-5 opacity-80 group-hover:opacity-100 transition-opacity"
            />
            <span className="text-sm font-medium text-gray-600 dark:text-gray-300">
