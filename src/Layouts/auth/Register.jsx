        ...
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <img
              ...
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuBVb7we3vxTfLh0keA5xhsa1F7qsi_7Vsgj3hymlpOqQMC2LFdEysvGAmHFIjGDU0FtkheDxAl029BtqUhhfzjhsRH4ZaMfTM65sSPmDiIBWoABfWCVJaAWVCWUXqTBY3joPx9nA9jaLq1YcWBSFTIfk7_o9ibkHbesCy108WoPRQe7khjggYMIpblFB3qegid5Hg9Jve3Lts6LvwL-g9i4aAJWEEuTK-TpTtUA2gWXKs8uDxOuP0LYhrJ_t0fPe0_pXChtkqgTGcE"
            />
              ...
              <div className="flex flex-col md:flex-row h-full">
                ...
                <div className="flex-1 p-8 md:p-10 lg:p-12 relative">
                  ...
                  <div className="mt-10 flex flex-col items-center gap-4">
                    ...
                    >
                      <span className="tracking-wide text-lg">Đăng ký ngay</span>
