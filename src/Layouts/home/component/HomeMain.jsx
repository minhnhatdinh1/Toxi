  ...
  const heroSlides = [
    {
      ...
      subtitle: "Lộ trình HSK hiện đại, gọn mắt và tập trung hơn cho phần đầu trang.",
      image: "https://lh3.googleusercontent.com/aida-public/AB6AXuAwsBsZIsyCmtSVufrnW8IQ3OcNeGQO6uv5_S2x_YweK8CwOgxS_j8F_1UlAP1CKu-MJ4a6fHrmJFtzUUcb_X4KSq8qWpLna00jvHLg7DEjci3_9aaWB-JPpLO0hbOLKlLYbtXWV_1gq2dYp2AdtNDqJHNF-j2XA-3y-JFm721_M16loDAuswddRMrVB91_VS9Tc0bFgo4Ft74lY4nteoQG2dIzPct6KXEEJ9A_vnNS8l55l5dzg3f46GB6CxSZ1N3nNlKt4Oc23S0",
      accent: "HSK Roadmap",
    },
    {
      eyebrow: "Compact Banner",
      title: "Luyện thi theo phong cách banner gọn",
      subtitle: "Ảnh nhỏ hơn, nền sạch hơn và có thể chuyển qua lại bằng chấm điều hướng.",
      image: "https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=1600&q=80",
      accent: "Smart Layout",
    },
    {
      eyebrow: "Daily Practice",
      title: "Học đều mỗi ngày với bài luyện và tài liệu",
      subtitle: "Hero mới ưu tiên hình ảnh vừa phải, nội dung rõ ràng và không cần hai nút lớn.",
  ...
  return (
    <>
                  ...
                  <div className="relative z-10 flex h-full items-center justify-center px-6 py-8 sm:px-10 lg:px-14">
                    <div className="mx-auto max-w-3xl text-center text-white">
                      ...
                      <div className="mt-6 flex items-center justify-center gap-4">
                        ...
                        <div className="text-sm font-semibold text-white/80">10.000+ học viên</div>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="hidden relative min-h-[580px] md:min-h-[660px] w-full bg-primary overflow-hidden group">
        ...
        <div className="hero-char absolute top-[30%] right-[8%] text-secondary/10 font-serif text-[60px] leading-none select-none pointer-events-none hidden xl:block" style={{ animationDelay: '1s' }}>道</div>
        ...
        <div className="relative overflow-hidden mt-2">
          <div className="marquee-track">
            {['Viện Khổng Tử', 'HanNom Institute', 'Đại học Hà Nội', 'ĐH Ngoại thương', 'HSK Vietnam', 'Confucius HN', 'Viện Khổng Tử', 'HanNom Institute', 'Đại học Hà Nội', 'ĐH Ngoại thương', 'HSK Vietnam', 'Confucius HN'].map((name, i) => (
              <div key={i} className="flex items-center gap-2 px-6 py-2 rounded-full bg-slate-50 border border-slate-200 shrink-0">
      ...
      {/* ══════════════════════════════════════════════
          3. STATS SECTION
      ══════════════════════════════════════════════ */}
      <FadeSection className="bg-gradient-to-br from-primary to-[#7a0015] py-16 px-4 md:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="text-center p-6 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-sm">
      ...
      {/* ══════════════════════════════════════════════
          4. COURSES (tabbed)
      ══════════════════════════════════════════════ */}
      <section className="py-20 px-6 md:px-12 lg:px-16 bg-surface" id="courses">
        <div className="max-w-5xl mx-auto">
          <FadeSection>
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-3">Chọn lộ trình phù hợp</h2>
              <p className="text-slate-500 max-w-lg mx-auto">Từ con số 0 đến thành thạo — TOXI có mọi khóa học bạn cần.</p>
            </div>

            {/* Tabs */}
            <div className="flex justify-center mb-10">
              <div className="inline-flex bg-white rounded-2xl p-1.5 shadow-md border border-slate-100 gap-1">
                {courseTabs.map((tab, i) => (
                  <button key={i} onClick={() => setActiveTab(i)}
                    className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold transition-all duration-300 ${activeTab === i ? 'bg-primary text-white shadow-lg' : 'text-slate-500 hover:text-primary'}`}>
            ...
            <FadeSection>
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={i} className={`card-lift bg-white rounded-2xl p-7 border border-slate-100 shadow-sm`}>
                    <div className={`w-14 h-14 rounded-2xl ${c.bg} ${c.color} flex items-center justify-center mb-5`}>
      ...
      {/* ══════════════════════════════════════════════
          5. HSK LEARNING PATH
      ══════════════════════════════════════════════ */}
      <FadeSection className="py-20 px-6 md:px-12 lg:px-16 bg-white" id="hsk">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-3">Lộ trình HSK từ A→Z</h2>
            <p className="text-slate-500 max-w-lg mx-auto">Mỗi cấp độ được thiết kế bám sát tiêu chuẩn HSK quốc tế mới nhất 3.0</p>
          </div>
          ...
          <div className="md:hidden space-y-4">
            {hskPath.map((node, i) => (
              <div key={i} className="flex items-center gap-4 bg-white rounded-2xl p-4 border border-slate-100 shadow-sm">
      ...
      {/* ══════════════════════════════════════════════
          6. WHY TOXI (upgraded)
      ══════════════════════════════════════════════ */}
      <FadeSection className="py-20 px-6 md:px-12 lg:px-16 bg-slate-50" id="why">
        <div className="max-w-5xl mx-auto">
            ...
            <div className="relative order-2 lg:order-1">
              <div className="aspect-[4/5] rounded-t-full rounded-b-3xl overflow-hidden shadow-2xl border-[8px] border-white">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent flex items-end p-8">
                  <p className="text-white font-serif text-xl italic text-center w-full">"Ngôn ngữ là cầu nối văn hóa"</p>
                </div>
              </div>
              {/* Stat badges */}
              <div className="absolute -right-4 top-1/4 bg-white rounded-2xl p-4 shadow-xl border border-slate-100">
                <div className="text-3xl font-black text-primary">95%</div>
                <div className="text-xs text-slate-500">Tỉ lệ đạt HSK 4+</div>
              </div>
              <div className="absolute -left-4 bottom-1/4 bg-secondary rounded-2xl p-4 shadow-xl">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-4 p-4 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:border-secondary/30 transition-all group">
      ...
      {/* ══════════════════════════════════════════════
          7. INSTRUCTORS
      ══════════════════════════════════════════════ */}
      <FadeSection className="py-20 px-6 md:px-12 lg:px-16 bg-white" id="instructors">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-3">Học từ những chuyên gia hàng đầu</h2>
            <p className="text-slate-500 max-w-lg mx-auto">Giảng viên TOXI đều có chứng chỉ quốc tế và kinh nghiệm thực tiễn tại Trung Quốc.</p>
          </div>
      ...
      {/* ══════════════════════════════════════════════
          8. TESTIMONIALS
      ══════════════════════════════════════════════ */}
      <FadeSection className="py-20 px-6 md:px-12 lg:px-16 bg-primary relative overflow-hidden" id="testimonials">
        <div className="absolute inset-0 bg-chinese-pattern opacity-8" />
        <div className="max-w-5xl mx-auto relative z-10">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white mb-3">10.000+ học viên tin tưởng</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
      ...
      {/* ══════════════════════════════════════════════
          9. STORE
      ══════════════════════════════════════════════ */}
      <FadeSection className="py-20 px-6 md:px-12 lg:px-16 bg-surface" id="store">
        <div className="max-w-5xl mx-auto">
      ...
      {/* ══════════════════════════════════════════════
          10. BLOG
      ══════════════════════════════════════════════ */}
      <FadeSection className="py-20 px-6 md:px-12 lg:px-16 bg-white" id="blog">
        <div className="max-w-5xl mx-auto">
      ...
      {/* ══════════════════════════════════════════════
          11. FAQ
      ══════════════════════════════════════════════ */}
      <FadeSection className="py-20 px-6 md:px-12 lg:px-16 bg-slate-50" id="faq">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-black text-slate-900 mb-3">Câu hỏi thường gặp</h2>
            <p className="text-slate-500">Không tìm thấy câu trả lời? Liên hệ tư vấn viên qua hotline.</p>
          </div>
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                <button onClick={() => setActiveFaq(activeFaq === i ? null : i)}
                  className="w-full flex items-center justify-between px-6 py-4 text-left font-bold text-slate-900 hover:text-primary transition-colors">
                  <span>{faq.q}</span>
                ...
                <div className={`faq-answer ${activeFaq === i ? 'open' : ''} px-6 pb-0`}>
      ...
      {/* ══════════════════════════════════════════════
          12. FINAL CTA
      ══════════════════════════════════════════════ */}
      <FadeSection className="py-24 px-6 md:px-12 bg-gradient-to-br from-primary via-[#8a000e] to-[#7a0015] relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 mb-6 border border-secondary/50 bg-white/10 backdrop-blur-sm text-secondary px-5 py-2 rounded-full">
          ...
          <p className="text-slate-200 text-lg mb-10 max-w-xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/practice"
              className="px-10 py-4 bg-secondary text-primary font-black rounded-xl shadow-[0_6px_0_#b8860b] active:shadow-none active:translate-y-1 hover:bg-yellow-300 transition-all flex items-center justify-center gap-2 text-lg">
              <span className="material-symbols-outlined">quiz</span>
              Test trình độ MIỄN PHÍ
            </Link>
            <Link to="/course"
              className="px-10 py-4 bg-white/15 border-2 border-white/30 text-white font-bold rounded-xl hover:bg-white/25 backdrop-blur-sm transition-all flex items-center justify-center gap-2 text-lg">
              <span className="material-symbols-outlined">school</span>
              Xem tất cả khóa học
            </Link>
          </div>
          <p className="text-white/50 text-sm mt-6">✓ Miễn phí hoàn toàn &nbsp;·&nbsp; ✓ Không cần thẻ tín dụng &nbsp;·&nbsp; ✓ Kết quả ngay lập tức</p>
        </div>
      </FadeSection>
    </>
  );
